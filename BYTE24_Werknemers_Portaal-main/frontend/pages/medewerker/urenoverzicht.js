...
export default function Urenoverzicht() {
  ...
  const [totaleUren, setTotaleUren] = useState("");
  ...
  const addUren = async () => {
    try {
      await axios.post(
        `${API_URL}/werknemer/uren-toevoegen`,
        {
  ...
  const onDelete = async () => {
    ...
    try {
      await axios.post(
        `${API_URL}/werknemer/uren-verwijderen`,
        {
          id: clickedHour,
        },
        ApiConfig
  ...
  const onUpdate = async () => {
    ...
    try {
      await axios.post(
        `${API_URL}/werknemer/uren-updaten`,
        {
          start_date: beginDate,
          start_hour: beginUren,
          end_hour: endUren,
          ...
          <div class="mx-auto lg:ml-80">
            ...
            <div className="container px-4 mx-auto">
              ...
              <select
                id="location"
                name="location"
                className="mt-1 block w-1/12 pl-3 py-2  text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md "
                defaultValue="Period"
              >
            ...
            <section class="py-8">
              <div class="container px-4 mx-auto">
                <div class="p-2 mb-6 bg-white shadow rounded">
                  <h3 className="text-lg leading-6 text-gray-500 font-medium text-center">
                    ADD WORKING HOURS
                  </h3>
                  <form className="p-2 mt-1 sm:flex sm:items-center text-center space-x-8 bg-gray-50 justify-between">
                    <div className="w-32 sm:max-w-xs">
                    ...
                    <div className="w-1/12 sm:max-w-xs">
                      ...
                      <input
                        ...
                        onChange={(e) => setBeginUren(e.target.value)}
                      ></input>
                    </div>
                    <div className="w-1/12 sm:max-w-xs">
                      ...
                      <input
                        ...
                        style={{ marginRight: "10px" }}
                        onChange={(e) => setEndUren(e.target.value)}
                      ></input>
                    </div>
                    <div className="w-1/12 sm:max-w-xs">
                      ...
                      <input
                        ...
                        style={{ marginRight: "10px" }}
                        onChange={(e) => setBreakUren(e.target.value)}
                      ></input>
                    </div>
                    <button
                      type="button"
                    ...
                    <div className=" flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <div className="">
                              <p className="text-xs p-1"> Datum </p>
                              <label htmlFor="date" className="sr-only">
                                Datum
                              </label>
                              <DatePicker
