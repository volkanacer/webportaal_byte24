...
export default function medewerkerLijst() {
  ...
  const [employeeZipcode, setZipcode] = useState("");
  const [employeeCity, setCity] = useState("");
  const [open, setOpen] = useState(false);
  const [openUpdate, setOpenUpdate] = useState(false);
  const [openDelete, setOpenDelete] = useState(false);
  const [medewerker, setMedewerker] = useState([]);
  const [clickedMedewerker, setClickedMedewerker] = useState();
  ...
  const getMedewerker = async () => {
    ...
    try {
      const response = await axios.get(`${API_URL}/admin/werknemer`, ApiConfig);
  ...
  const onDelete = async () => {
    console.log(clickedMedewerker); // Verwijderen van medewerkers & vragen of de gebruiker het werkelijk wil verwijderen.
    try {
      await axios.post(
        `${API_URL}/admin/medewerker-verwijderen`,
        {
          id: clickedMedewerker,
        },
        ApiConfig
      );
      setOpen(false);
  ...
  const onUpdate = async () => {
    // Updaten van medewerkers
    try {
      await axios.post(
        `${API_URL}/admin/medewerker-updaten`,
        {
          first_name: employeeFirstName,
          last_name: employeeLastName,
          email: employeeEmail,
  ...
  return (
    <body class="antialiased bg-body text-body font-body p-5">
      <div class="">
        <div>
            ...
            <section class="py-8 px-6">
              <div class="flex flex-wrap -mx-3 items-center">
                <div class="w-full lg:w-1/2 flex items-center mb-5 lg:mb-0 px-3">
                  ...
                  <div>
                    <h2 class="mb-1 text-2xl font-bold">Employee List</h2>
                  </div>
                </div>
              </div>
            </section>
            ...
            <Transition.Root show={open} as={Fragment}>
              ...
              >
                <div className=" flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                  ...
                  >
                    <div
                      /* Update Venster */ className="inline-block bg-white rounded-lg pb-10 px-20 pt-10 text-center overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle  "
                    >
                      <div className="">
                        <div className="">
                          <Dialog.Title
                        ...
                        <div className=" flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <div className="">
                                  <p className="text-xs p-1"> First Name </p>
                                  ...
                                  <p className="text-xs p-1"> Last Name </p>
                                  ...
                                  <p className="text-xs p-1"> Email </p>
                                  <label htmlFor="start" className="sr-only">
                                    Email
                                  </label>
                                  <input
                                  ...
                                  <p className="text-xs p-1"> Address </p>
                                  <label htmlFor="start" className="sr-only">
                                    Address
                                  </label>
                                  <input
                                  ...
                                  ></input>
                                  <p className="text-xs p-1"> Zip Code </p>
                                  <label htmlFor="start" className="sr-only">
                                    Zip Code
                                  </label>
                                  <input
                                  ...
                                  ></input>
                                  <p className="text-xs p-1"> City </p>
                                  <label htmlFor="start" className="sr-only">
                                    City
                                  </label>
                                  <input
